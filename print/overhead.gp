...
'' using ($0-0.04):($4+35):4 with labels title ' ' font "arial, 10" textcolor lt 0		,\
'' using ($0+0.15):($5+35):5 with labels title ' ' font "arial, 10" textcolor lt 0	,\
'' using ($0+0.3):($6+35):6 with labels title ' ' font "arial, 10" textcolor lt 0